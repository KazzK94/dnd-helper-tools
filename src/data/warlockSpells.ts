...
export const WARLOCK_SPELLS: Spell[] = [
	...
	},
	{
		...
		duration: "1 minute (C)",
		description:
			"A creature you can see makes a Wisdom Save, on a failed save they get the Charmed condition. The spell ends early if the target takes damage, if you attack them, or if you force anyone to make any saving throw. When it ends, the target knows that you charmed them. (It only affects humanoids that are you figthing you, and has a 24h cooldown per target.)",
		source: "EI: Pact of the Tome",
	},
	{
		name: "Produce Flame",
		level: 0,
		...
		duration: "10 minutes",
		description:
			"A flickering flame appears in your hand, which emits no heat and burns nothing. It sheds bright light in a 20-foot radius and dim light for an additional 20 feet. You can take a Magic Action to hurl it at a creature or object within 60ft. Make a ranged spell attack and, on a hit, deal 2d8 Fire damage.",
		source: "EI: Pact of the Tome",
	},
	{
		...
		duration: "Instant",
		description:
			"You unleash a string of insults laced with subtle enchantments at a creature you can see within range. If the target can hear you, it must succeed on a Wisdom saving throw or take 2d6 Psychic damage and have disadvantage on the next attack roll it makes before the end of its next turn.",
		source: "EI: Pact of the Tome",
	},
	{
		name: "Toll the Dead",
